...
export default function EditParty() {
  ...
  const loadParty = async () => {
    try {
      ...
      if (!res.ok) {
        toast({
          title: "Error",
          description: "Unable to load party data",
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        title: "Error",
        description: "Server error while loading party",
        variant: "destructive",
      });
    }
  };
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      toast({
        title: "Server Error",
        description: "Could not update party",
        variant: "destructive",
      });
    }
  ...
  return (
    <div className="w-full p-6 bg-[#f6f7fb] text-gray-900">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-12 gap-4 mt-6">
            ...
            <div className="col-span-3">
              ...
              >
                ...
                <option value="_create" style={{ fontWeight: "bold" }}>
                  + Create Category
                </option>
              </select>
            </div>
        ...
        {/* ADDRESS, CONTACT PERSON – SAME AS CREATE */}
        {/* I AM NOT CUTTING ANYTHING. EXACT SAME UI BELOW */}
